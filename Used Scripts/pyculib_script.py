...
ssd = pd.DataFrame(data=temp_dict)
ssd.to_csv("cusparse_sparseCSR_dense_sparse.csv")
...
ssd = pd.DataFrame(data=temp_dict)
ssd.to_csv("cusparse_sparseCSR_dense_higherN.csv")
...
ssd = pd.DataFrame(data=temp_dict)
ssd.to_csv("cusparse_sparseCSR_denseVector_sparse.csv")
...
ssd = pd.DataFrame(data=temp_dict)
ssd.to_csv("cusparse_sparseCSR_denseVector_higherN.csv")
